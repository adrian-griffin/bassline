"""Manages persistent data about the result of the most recent Bassline update.

The update result store stores and fetches the result of the last update.
Because the Bassline server holds no state in memory, it relies on files stored
