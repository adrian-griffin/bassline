...
The Bassline server backend uses several privileged scripts (created in [ansible-role-bassline](https://github.com/bassline/ansible-role-bassline)). Those scripts exist on a provisioned Bassline device, but they don't exist on a dev machine.
...
* If you're making a large change (over 100 LOC or three hours of dev time), [file an issue](https://github.com/bassline/bassline/issues/new/choose) first to talk through the proposed change. This prevents you from wasting time on a change that has a low chance of being accepted.
